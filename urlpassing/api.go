...
type userstuff struct{
    Name, BirthMonth, BirthDay, BirthYear string
}
...
func formhandler(w http.ResponseWriter, r *http.Request) {
	user := userstuff{r.FormValue("name"),r.FormValue("BirthMonth"),r.FormValue("BirthDay"),r.FormValue("BirthYear")}
...
func linkone(w http.ResponseWriter, r *http.Request) {
    thisuser := r.FormValue("name")+" "+r.FormValue("BirthMonth")+" "+r.FormValue("BirthDay") +" " + r.FormValue("BirthYear")
